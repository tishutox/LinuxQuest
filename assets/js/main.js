...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'Pop!_OS', codebase: 'ubuntu', countries: ['us'], isoSizeMb: 3100, tags: ['gaming', 'programmierer', 'gutes-design'], docsUrl: 'https://support.system76.com/', downloadUrl: 'https://pop.system76.com/', description: 'System76-Distribution mit Cosmic/GNOME, GPU-Optimierungen und Dev-/Creator-Fokus.' },
   { name: 'Kali Linux', codebase: 'debian', countries: ['international'], isoSizeMb: 4400, tags: ['it-sicherheit', 'forensik', 'fuer-experten'], docsUrl: 'https://www.kali.org/docs/', downloadUrl: 'https://www.kali.org/get-kali/', description: 'Offensive-Security-Distribution mit umfangreichen Pen-Testing-Tools.' },
   { name: 'Parrot Security', codebase: 'debian', countries: ['it'], isoSizeMb: 4300, tags: ['it-sicherheit', 'forensik', 'privacy'], docsUrl: 'https://www.parrotsec.org/docs/', downloadUrl: 'https://parrotsec.org/download/', description: 'Security- und Forensik-Distribution mit Fokus auf Privacy und leichte Images.' },
   { name: 'Tails', codebase: 'debian', countries: ['fr'], isoSizeMb: 1300, tags: ['privacy', 'it-sicherheit', 'barrierefreiheit'], docsUrl: 'https://tails.net/doc/index.en.html', downloadUrl: 'https://tails.net/install/index.en.html', description: 'Amnesische Live-Distribution für Anonymität über Tor; keine Spuren auf dem Host.' },
   ...
   { name: 'MX Linux', codebase: 'debian', countries: ['us'], isoSizeMb: 2200, tags: ['einsteigerfreundlich', 'lightweight', 'systemd-free'], docsUrl: 'https://mxlinux.org/wiki/', downloadUrl: 'https://mxlinux.org/downloads/', description: 'Debian Stable mit Xfce/Fluxbox, systemd-frei und sehr einsteigerfreundlich.' },
   { name: 'Devuan', codebase: 'debian', countries: ['us'], isoSizeMb: 1700, tags: ['systemd-free', 'server', 'privacy'], docsUrl: 'https://www.devuan.org/os/documentation', downloadUrl: 'https://www.devuan.org/get-devuan', description: 'Systemd-freier Debian-Fork mit Fokus auf Init-Wahlfreiheit.' },
   ...
   { name: 'Garuda Linux', codebase: 'arch', countries: ['in'], isoSizeMb: 4600, tags: ['gaming', 'gutes-design', 'rolling'], docsUrl: 'https://garudalinux.org/docs', downloadUrl: 'https://garudalinux.org/downloads.html', description: 'Arch-basiert mit Btrfs-Snapshots, Gaming-Tuning und KDE-zentriertem Design.' },
   { name: 'AthenaOS', codebase: 'arch', countries: ['it'], isoSizeMb: 3400, tags: ['it-sicherheit', 'forensik', 'rolling'], docsUrl: 'https://athenaos.org/docs', downloadUrl: 'https://athenaos.org/download', description: 'Arch-basierte Security-Distribution mit forensischem Fokus.' },
   ...
   { name: 'Fedora Server', codebase: 'redhat', countries: ['us'], isoSizeMb: 2000, tags: ['server', 'cloud', 'verwaltung'], docsUrl: 'https://docs.fedoraproject.org/en-US/fedora-server/', downloadUrl: 'https://getfedora.org/en/server/download/', description: 'Server-Edition mit Cockpit-Admin-Tools und kurzem Release-Zyklus.' },
   { name: 'Fedora Silverblue', codebase: 'redhat', countries: ['us'], isoSizeMb: 2900, tags: ['immutable', 'programmierer', 'privacy'], docsUrl: 'https://docs.fedoraproject.org/en-US/fedora-silverblue/', downloadUrl: 'https://fedoraproject.org/silverblue/', description: 'Unveränderliches Fedora mit rpm-ostree und GNOME für stabile Desktops.' },
   { name: 'Nobara', codebase: 'redhat', countries: ['us'], isoSizeMb: 4400, tags: ['gaming', 'content-creation', 'einsteigerfreundlich'], docsUrl: 'https://nobaraproject.org/docs/', downloadUrl: 'https://nobaraproject.org/downloads/', description: 'Gaming-/Creator-orientierter Fedora-Spin mit vorinstallierten Tweaks.' },
   { name: 'Bazzite', codebase: 'redhat', countries: ['us'], isoSizeMb: 4700, tags: ['gaming', 'immutable', 'einsteigerfreundlich'], docsUrl: 'https://bazzite.gg/docs', downloadUrl: 'https://bazzite.gg/download', description: 'Fedora-Atomic-Variante optimiert für Gaming und Streaming (Universal Blue).' },
   { name: 'ChimeraOS', codebase: 'independent', countries: ['us'], isoSizeMb: 3300, tags: ['gaming', 'rolling', 'fuer-experten'], docsUrl: 'https://chimeraos.org/docs', downloadUrl: 'https://chimeraos.org/download', description: 'Gaming-fokussierte Rolling-Distribution mit Steam-Big-Picture-Erlebnis.' },
   { name: 'CachyOS', codebase: 'arch', countries: ['de'], isoSizeMb: 2400, tags: ['lightweight', 'gaming', 'gutes-design'], docsUrl: 'https://wiki.cachyos.org', downloadUrl: 'https://cachyos.org/download/', description: 'Arch-basiert mit Performance-Optimierungen, ZFS/Btrfs-Optionen und Gaming-Fokus.' },
   { name: 'SteamOS', codebase: 'arch', countries: ['us'], isoSizeMb: 3500, tags: ['gaming', 'rolling', 'immutable'], docsUrl: 'https://help.steampowered.com/en/faqs/view/3F7F-2E2A-5D28-3E4F', downloadUrl: 'https://repo.steampowered.com/download/SteamOS-3.5.iso', description: 'Valve/Arch-basierte Gaming-Distribution für Steam Deck und PC, rolling/immutable.' },
   { name: 'AlmaLinux', codebase: 'redhat', countries: ['us'], isoSizeMb: 13340, tags: ['server', 'long-term-support', 'verwaltung'], docsUrl: 'https://wiki.almalinux.org', downloadUrl: 'https://almalinux.org/get-almalinux/', description: 'RHEL-kompatibler Community-Rebuild mit stabilem Langzeit-Support.' },
   { name: 'Rocky Linux', codebase: 'redhat', countries: ['us'], isoSizeMb: 9278, tags: ['server', 'long-term-support', 'cloud'], docsUrl: 'https://docs.rockylinux.org', downloadUrl: 'https://rockylinux.org/download', description: 'RHEL-kompatibler Community-Rebuild mit Fokus auf Stabilität und LTS.' },
   ...
   { name: 'SLES', codebase: 'suse', countries: ['de'], isoSizeMb: 1200, tags: ['server', 'long-term-support', 'cloud'], docsUrl: 'https://documentation.suse.com/sles/', downloadUrl: 'https://www.suse.com/download/sles/', description: 'Enterprise-Distribution von SUSE mit langem Support und YaST-Tooling.' },
   { name: 'Gentoo', codebase: 'gentoo', countries: ['us'], isoSizeMb: 1000, tags: ['source-based', 'fuer-experten', 'lightweight'], docsUrl: 'https://wiki.gentoo.org', downloadUrl: 'https://www.gentoo.org/downloads/', description: 'Quellbasierte Metadistribution mit Portage-Paketverwaltung und maximaler Anpassung.' },
   { name: 'Slackware', codebase: 'slackware', countries: ['us'], isoSizeMb: 3200, tags: ['fuer-experten', 'systemd-free', 'programmierer'], docsUrl: 'https://docs.slackware.com', downloadUrl: 'https://mirrors.slackware.com/slackware/', description: 'Älteste aktive Linux-Distribution mit KISS-Ansatz und klassischem BSD-Init.' },
   { name: 'VectorLinux', codebase: 'slackware', countries: ['ca'], isoSizeMb: 700, tags: ['lightweight', 'systemd-free', 'fuer-experten'], docsUrl: 'http://vectorlinux.osuosl.org/docs/', downloadUrl: 'https://sourceforge.net/projects/vectorlinux/files/', description: 'Slackware-basierte, schlanke Distribution; Fokus auf Geschwindigkeit und Einfachheit.' },
   { name: 'Void Linux', codebase: 'independent', countries: ['es'], isoSizeMb: 900, tags: ['lightweight', 'systemd-free', 'rolling'], docsUrl: 'https://docs.voidlinux.org', downloadUrl: 'https://voidlinux.org/download/', description: 'Unabhängige Rolling-Distribution mit runit-Init und musl/glibc-Optionen.' },
   { name: 'Nitrux', codebase: 'debian', countries: ['mx'], isoSizeMb: 2900, tags: ['gutes-design', 'einsteigerfreundlich', 'programmierer'], docsUrl: 'https://nxos.org/faq/', downloadUrl: 'https://nxos.org/download/', description: 'Debian-basierte Desktop-Distribution mit Maui Shell/KDE und AppImage-Fokus.' },
   { name: 'Zentyal Server', codebase: 'ubuntu', countries: ['es'], isoSizeMb: 1800, tags: ['server', 'verwaltung', 'cloud'], docsUrl: 'https://doc.zentyal.org', downloadUrl: 'https://zentyal.com/community/', description: 'Small-Business-Server auf Ubuntu-Basis mit AD/Samba-Integration.' },
   { name: 'AUSTRUMI', codebase: 'independent', countries: ['lv'], isoSizeMb: 700, tags: ['lightweight', 'datenrettung', 'einsteigerfreundlich'], docsUrl: 'https://austrumi.lv/', downloadUrl: 'https://sourceforge.net/projects/austrumi/files/', description: 'Leichtgewichtige lettische Live-Distribution für ältere Hardware und Rettungseinsätze.' },
   { name: 'AryaLinux', codebase: 'independent', countries: ['in'], isoSizeMb: 2300, tags: ['programmierer', 'fuer-experten', 'source-based'], docsUrl: 'https://aryalinux.org/wiki/', downloadUrl: 'https://aryalinux.org/?page_id=36', description: 'Quellbasierte Distribution mit eigenem Build-System für erfahrene Nutzer.' },
   { name: 'MIRACLE LINUX', codebase: 'redhat', countries: ['jp'], isoSizeMb: 1300, tags: ['server', 'long-term-support', 'verwaltung'], docsUrl: 'https://www.cybertrust.co.jp/miraclelinux/', downloadUrl: 'https://www.cybertrust.co.jp/miraclelinux/download/', description: 'RHEL-kompatible Enterprise-Distribution aus Japan.' },
   { name: 'Regata OS', codebase: 'suse', countries: ['br'], isoSizeMb: 4300, tags: ['gaming', 'content-creation', 'gutes-design'], docsUrl: 'https://www.regataos.com.br/en/support', downloadUrl: 'https://www.regataos.com.br/en/download', description: 'openSUSE-basierte Desktop-Distribution mit Gaming-Tools und Multimedia-Fokus.' },
   { name: 'NethServer', codebase: 'redhat', countries: ['it'], isoSizeMb: 1200, tags: ['server', 'verwaltung', 'cloud'], docsUrl: 'https://docs.nethserver.org', downloadUrl: 'https://www.nethserver.org/getting-started/', description: 'Modularer Small-Business-Server (ehemals CentOS/RHEL-basiert).'},
   { name: 'openmamba', codebase: 'independent', countries: ['it'], isoSizeMb: 2500, tags: ['office', 'einsteigerfreundlich', 'gutes-design'], docsUrl: 'https://wiki.openmamba.org', downloadUrl: 'https://openmamba.org/en/download/', description: 'Italienische Rolling-Distribution mit hauseigenem Paket-Ökosystem.' },
   { name: 'NimbleX', codebase: 'slackware', countries: ['ro'], isoSizeMb: 1200, tags: ['lightweight', 'datenrettung', 'systemd-free'], docsUrl: 'https://nimblex.net/', downloadUrl: 'https://sourceforge.net/projects/nimblex/files/latest/download', description: 'Slackware-basierte Live-Distribution, optimiert für schnelle Einsätze und Rettung.' },
   { name: 'NuTyX', codebase: 'independent', countries: ['ch'], isoSizeMb: 1500, tags: ['rolling', 'source-based', 'fuer-experten'], docsUrl: 'https://www.nutyx.org/en/documentation', downloadUrl: 'https://www.nutyx.org/en/downloads', description: 'Unabhängige Rolling-Distribution mit cards-Paketmanager und Quelle-basiertem Ansatz.' },
   { name: 'LliureX', codebase: 'ubuntu', countries: ['es'], isoSizeMb: 3900, tags: ['bildung', 'office', 'einsteigerfreundlich'], docsUrl: 'https://portal.edu.gva.es/lliurex/', downloadUrl: 'https://portal.edu.gva.es/lliurex/va/descarga/', description: 'Bildungsdistribution der Generalitat Valenciana, Ubuntu-basiert.' },
   { name: 'SparkyLinux', codebase: 'debian', countries: ['pl'], isoSizeMb: 2100, tags: ['lightweight', 'rolling', 'einsteigerfreundlich'], docsUrl: 'https://wiki.sparkylinux.org/', downloadUrl: 'https://sparkylinux.org/download/', description: 'Debian-basiertes Rolling-System, leichtgewichtig mit vorgefertigten Desktops.' },
   { name: 'Canaima', codebase: 'debian', countries: ['ve'], isoSizeMb: 2800, tags: ['bildung', 'office', 'verwaltung'], docsUrl: 'https://wiki.canaima.softwarelibre.gob.ve', downloadUrl: 'https://canaima.softwarelibre.gob.ve/descarga/', description: 'Venezolanische Debian-basierte Distribution für Bildung und Verwaltung.' },
   { name: 'ExTiX', codebase: 'ubuntu', countries: ['se'], isoSizeMb: 3600, tags: ['rolling', 'fuer-experten', 'programmierer'], docsUrl: 'https://www.extix.se', downloadUrl: 'https://sourceforge.net/projects/extix/files/', description: 'Schwedische Ubuntu/Deepin-basierte Rolling-Distribution mit häufigen Releases.' },
   { name: 'endeavouros-arm', codebase: 'arch', countries: ['nl'], isoSizeMb: 2400, tags: ['rolling', 'programmierer', 'fuer-experten'], docsUrl: 'https://discovery.endeavouros.com/arm/arm-install/2021/03/', downloadUrl: 'https://github.com/endeavouros-team/EndeavourOS-ARM-images/releases', description: 'EndeavourOS-Variante für ARM-Boards mit schnellem Installer und Rolling-Updates.' },
   ...
   { name: 'Qubes OS', codebase: 'independent', countries: ['international'], isoSizeMb: 5000, tags: ['it-sicherheit', 'privacy', 'fuer-experten'], docsUrl: 'https://www.qubes-os.org/doc/', downloadUrl: 'https://www.qubes-os.org/downloads/', description: 'Sicherheitsfokussiertes OS mit Isolation über Xen-VMs (Security by Compartmentalization).' },
   ...
   { name: 'Rescatux', codebase: 'debian', countries: ['es'], isoSizeMb: 800, tags: ['datenrettung', 'disk-management', 'einsteigerfreundlich'], docsUrl: 'https://www.rescatux.org', downloadUrl: 'https://www.rescatux.org/download/', description: 'Live-Tool zum Reparieren von Bootloadern, Passwörtern und Dateisystemen.' },
   { name: 'SystemRescue', codebase: 'independent', countries: ['fr'], isoSizeMb: 900, tags: ['datenrettung', 'disk-management', 'forensik'], docsUrl: 'https://www.system-rescue.org/Documentation/', downloadUrl: 'https://www.system-rescue.org/Download/', description: 'Live-Rescue-System mit Schwerpunkt auf Backup, Recovery und Forensik.' },
   { name: 'Clonezilla Live', codebase: 'debian', countries: ['tw'], isoSizeMb: 4200, tags: ['datenrettung', 'disk-management', 'verwaltung'], docsUrl: 'https://clonezilla.org/clonezilla-live.php', downloadUrl: 'https://clonezilla.org/downloads.php', description: 'Live-Umgebung für Backup, Imaging und Klonen von Systemen.' },
   { name: 'Trisquel', codebase: 'ubuntu', countries: ['es'], isoSizeMb: 2700, tags: ['privacy', 'bildung', 'barrierefreiheit'], docsUrl: 'https://trisquel.info/en/wiki', downloadUrl: 'https://trisquel.info/en/download', description: 'FSF-akkreditierte, vollständig freie Ubuntu-basierte Distribution.' },
   { name: 'Puppy Linux', codebase: 'independent', countries: ['au'], isoSizeMb: 700, tags: ['lightweight', 'datenrettung', 'einsteigerfreundlich'], docsUrl: 'https://puppylinux.com/', downloadUrl: 'https://puppylinux.com/download.html', description: 'Ultraleichte Live-Distribution für ältere Hardware und portable Einsätze.' },
   { name: 'Oracle Linux', codebase: 'redhat', countries: ['us'], isoSizeMb: 1200, tags: ['cloud', 'server', 'verwaltung'], docsUrl: 'https://docs.oracle.com/en/operating-systems/oracle-linux/', downloadUrl: 'https://yum.oracle.com/oracle-linux-isos.html', description: 'RHEL-kompatible Enterprise-Distribution mit Oracle-Supportoptionen.' },
   { name: 'Photon OS', codebase: 'independent', countries: ['us'], isoSizeMb: 1000, tags: ['cloud', 'server', 'lightweight'], docsUrl: 'https://vmware.github.io/photon/', downloadUrl: 'https://vmware.github.io/photon/', description: 'VMware-optimierte, minimalistische Container- und Cloud-Distribution.' },
   { name: 'Ubuntu Server', codebase: 'ubuntu', countries: ['uk'], isoSizeMb: 1800, tags: ['server', 'cloud', 'long-term-support'], docsUrl: 'https://ubuntu.com/server/docs', downloadUrl: 'https://ubuntu.com/download/server', description: 'LTS-orientierte Server-Edition mit breitem Paket- und Cloud-Ökosystem.' },
   { name: 'Fedora Kinoite', codebase: 'redhat', countries: ['us'], isoSizeMb: 2900, tags: ['immutable', 'gutes-design', 'programmierer'], docsUrl: 'https://docs.fedoraproject.org/en-US/fedora-kinoite/', downloadUrl: 'https://fedoraproject.org/kinoite/', description: 'Unveränderliche Fedora-Variante mit KDE Plasma und rpm-ostree.' },
   { name: 'Bodhi Linux', codebase: 'ubuntu', countries: ['us'], isoSizeMb: 900, tags: ['lightweight', 'einsteigerfreundlich', 'bildung'], docsUrl: 'https://www.bodhilinux.com/docs/', downloadUrl: 'https://www.bodhilinux.com/download/', description: 'Ubuntu-basiert mit Moksha-Desktop; sehr ressourcenschonend und anpassbar.' },
   { name: 'Edubuntu', codebase: 'ubuntu', countries: ['uk'], isoSizeMb: 4200, tags: ['bildung', 'einsteigerfreundlich', 'office'], docsUrl: 'https://edubuntu.org/', downloadUrl: 'https://edubuntu.org/download', description: 'Ubuntu-Variante mit vorinstallierten Bildungs- und Klassenraumtools.' },
   { name: 'Clear Linux', codebase: 'independent', countries: ['us'], isoSizeMb: 1200, tags: ['fuer-experten', 'cloud', 'programmierer'], docsUrl: 'https://www.clearlinux.org/documentation', downloadUrl: 'https://www.clearlinux.org/downloads', description: 'Intel-optimierte Performance-Distribution mit Fokus auf Cloud/Workstation.' },
   { name: 'RHEL', codebase: 'redhat', countries: ['us'], isoSizeMb: 1300, tags: ['server', 'long-term-support', 'verwaltung'], docsUrl: 'https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux', downloadUrl: 'https://access.redhat.com/products/red-hat-enterprise-linux/evaluation', description: 'Enterprise-Distribution mit zertifiziertem Support und langem Lebenszyklus.' },
   { name: 'Alpine Linux', codebase: 'independent', countries: ['us'], isoSizeMb: 700, tags: ['lightweight', 'server', 'it-sicherheit'], docsUrl: 'https://docs.alpinelinux.org', downloadUrl: 'https://alpinelinux.org/downloads/', description: 'Musl-/BusyBox-basierte Minimal-Distribution, beliebt für Container und Server.' }
]
