...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'Zorin OS', codebase: 'ubuntu', countries: ['ie'], isoSizeMb: 3300, tags: ['barrierefreiheit', 'einsteigerfreundlich', 'office'], docsUrl: 'https://help.zorin.com', downloadUrl: 'https://zorin.com/os/download/', description: 'Windows-ähnliche Oberfläche für Umsteiger, basierend auf Ubuntu.', logo: 'assets/img/distros/Zorin OS.png' },
