...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'Kali Linux', codebase: 'debian', countries: ['international'], isoSizeMb: 4400, tags: ['it-sicherheit', 'forensik', 'fuer-experten'], docsUrl: 'https://www.kali.org/docs/', downloadUrl: 'https://www.kali.org/get-kali/', description: 'Offensive-Security-Distribution mit umfangreichen Pen-Testing-Tools.', logo: 'assets/img/distros/Kali Linux.png' },
   ...
   { name: 'Devuan', codebase: 'debian', countries: ['us'], isoSizeMb: 1700, tags: ['systemd-free', 'server', 'privacy'], docsUrl: 'https://www.devuan.org/os/documentation', downloadUrl: 'https://www.devuan.org/get-devuan', description: 'Systemd-freier Debian-Fork mit Fokus auf Init-Wahlfreiheit.', logo: 'assets/img/distros/Devuan.png' },
   ...
   { name: 'Gentoo', codebase: 'gentoo', countries: ['us'], isoSizeMb: 1000, tags: ['source-based', 'fuer-experten', 'lightweight'], docsUrl: 'https://wiki.gentoo.org', downloadUrl: 'https://www.gentoo.org/downloads/', description: 'Quellbasierte Metadistribution mit Portage-Paketverwaltung und maximaler Anpassung.', logo: 'assets/img/distros/Gentoo.png' },
   ...
   { name: 'MIRACLE LINUX', codebase: 'redhat', countries: ['jp'], isoSizeMb: 1300, tags: ['server', 'long-term-support', 'verwaltung'], docsUrl: 'https://www.cybertrust.co.jp/miraclelinux/', downloadUrl: 'https://www.cybertrust.co.jp/miraclelinux/download/', description: 'RHEL-kompatible Enterprise-Distribution aus Japan.', logo: 'assets/img/distros/MIRACLE LINUX.png' },
   ...
   { name: 'LliureX', codebase: 'ubuntu', countries: ['es'], isoSizeMb: 3900, tags: ['bildung', 'office', 'einsteigerfreundlich'], docsUrl: 'https://portal.edu.gva.es/lliurex/', downloadUrl: 'https://portal.edu.gva.es/lliurex/va/descarga/', description: 'Bildungsdistribution der Generalitat Valenciana, Ubuntu-basiert.', logo: 'assets/img/distros/LliureX.png' },
   ...
   { name: 'KDE neon', codebase: 'ubuntu', countries: ['de'], isoSizeMb: 3000, tags: ['gutes-design', 'office', 'einsteigerfreundlich'], docsUrl: 'https://neon.kde.org/faq', downloadUrl: 'https://neon.kde.org/download', description: 'KDEs Referenz-Desktop mit aktuellen Plasma-Versionen auf Ubuntu-Basis.', logo: 'assets/img/distros/KDE neon.png' },
   { name: 'Elementary OS', codebase: 'ubuntu', countries: ['us'], isoSizeMb: 2900, tags: ['gutes-design', 'einsteigerfreundlich', 'office'], docsUrl: 'https://support.elementary.io', downloadUrl: 'https://elementary.io/', description: 'Designorientierte Ubuntu-Variante mit Pantheon-Desktop.', logo: 'assets/img/distros/Elementary OS.png' },
