...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'VectorLinux', codebase: 'slackware', countries: ['ca'], isoSizeMb: 700, tags: ['lightweight', 'systemd-free', 'fuer-experten'] },
   { name: 'Void Linux', codebase: 'independent', countries: ['es'], isoSizeMb: 900, tags: ['lightweight', 'systemd-free', 'rolling'] },
   ...
   { name: 'Regata OS', codebase: 'suse', countries: ['br'], isoSizeMb: 4300, tags: ['gaming', 'content-creation', 'gutes-design'] },
   ...
   { name: 'NimbleX', codebase: 'slackware', countries: ['ro'], isoSizeMb: 1200, tags: ['lightweight', 'datenrettung', 'systemd-free'] },
   { name: 'NuTyX', codebase: 'independent', countries: ['ch'], isoSizeMb: 1500, tags: ['rolling', 'source-based', 'fuer-experten'] },
   ...
   { name: 'Trisquel', codebase: 'ubuntu', countries: ['es'], isoSizeMb: 2700, tags: ['privacy', 'bildung', 'barrierefreiheit'] },
   { name: 'Puppy Linux', codebase: 'independent', countries: ['au'], isoSizeMb: 700, tags: ['lightweight', 'datenrettung', 'einsteigerfreundlich'] },
