...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'LliureX', codebase: 'ubuntu', countries: ['es'], isoSizeMb: 3900, tags: ['bildung', 'office', 'einsteigerfreundlich'], docsUrl: 'https://portal.edu.gva.es/lliurex/', downloadUrl: 'https://portal.edu.gva.es/lliurex/va/descarga/', description: 'Bildungsdistribution der Generalitat Valenciana, Ubuntu-basiert.', logo: 'assets/img/distros/LliureX.png', videoUrl: 'https://youtu.be/_LcIa4AMDNE?si=WpOzlEu0jaA_xNIs' },
