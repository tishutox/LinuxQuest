...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'SparkyLinux', codebase: 'debian', countries: ['pl'], isoSizeMb: 2100, tags: ['lightweight', 'rolling', 'einsteigerfreundlich'], docsUrl: 'https://wiki.sparkylinux.org/', downloadUrl: 'https://sparkylinux.org/download/', description: 'Debian-basiertes Rolling-System, leichtgewichtig mit vorgefertigten Desktops.', logo: 'assets/img/distros/SparkyLinux.png', videoUrl: 'https://youtu.be/vijEGZwA-ts?si=T9UBxhf0i-ORn1w-' },
   ...
   { name: 'Trisquel', codebase: 'ubuntu', countries: ['es'], isoSizeMb: 2700, tags: ['privacy', 'bildung', 'barrierefreiheit'], docsUrl: 'https://trisquel.info/en/wiki', downloadUrl: 'https://trisquel.info/en/download', description: 'FSF-akkreditierte, vollständig freie Ubuntu-basierte Distribution.', logo: 'assets/img/distros/Trisquel.png', videoUrl: 'https://youtu.be/wJ_ZQ_JAN_I?si=ebyPS-E5dPXTuFL9' },
