...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'AthenaOS', codebase: 'arch', countries: ['it'], isoSizeMb: 3400, tags: ['it-sicherheit', 'forensik', 'rolling'], docsUrl: 'https://athenaos.org/docs', downloadUrl: 'https://athenaos.org/download', description: 'Arch-basierte Security-Distribution mit forensischem Fokus.', logo: 'assets/img/distros/AthenaOS.png' },
   ...
   { name: 'Bazzite', codebase: 'redhat', countries: ['us'], isoSizeMb: 4700, tags: ['gaming', 'immutable', 'einsteigerfreundlich'], docsUrl: 'https://bazzite.gg/docs', downloadUrl: 'https://bazzite.gg/download', description: 'Fedora-Atomic-Variante optimiert für Gaming und Streaming (Universal Blue).', logo: 'assets/img/distros/Bazzite.png' },
   { name: 'ChimeraOS', codebase: 'independent', countries: ['us'], isoSizeMb: 3300, tags: ['gaming', 'rolling', 'fuer-experten'], docsUrl: 'https://chimeraos.org/docs', downloadUrl: 'https://chimeraos.org/download', description: 'Gaming-fokussierte Rolling-Distribution mit Steam-Big-Picture-Erlebnis.', logo: 'assets/img/distros/ChimeraOS.png' },
   ...
   { name: 'AryaLinux', codebase: 'independent', countries: ['in'], isoSizeMb: 2300, tags: ['programmierer', 'fuer-experten', 'source-based'], docsUrl: 'https://aryalinux.org/wiki/', downloadUrl: 'https://aryalinux.org/?page_id=36', description: 'Quellbasierte Distribution mit eigenem Build-System für erfahrene Nutzer.', logo: 'assets/img/distros/AryaLinux.png' },
   ...
   { name: 'Canaima', codebase: 'debian', countries: ['ve'], isoSizeMb: 2800, tags: ['bildung', 'office', 'verwaltung'], docsUrl: 'https://wiki.canaima.softwarelibre.gob.ve', downloadUrl: 'https://canaima.softwarelibre.gob.ve/descarga/', description: 'Venezolanische Debian-basierte Distribution für Bildung und Verwaltung.', logo: 'assets/img/distros/Canaima.png' },
   ...
   { name: 'Bodhi Linux', codebase: 'ubuntu', countries: ['us'], isoSizeMb: 900, tags: ['lightweight', 'einsteigerfreundlich', 'bildung'], docsUrl: 'https://www.bodhilinux.com/docs/', downloadUrl: 'https://www.bodhilinux.com/download/', description: 'Ubuntu-basiert mit Moksha-Desktop; sehr ressourcenschonend und anpassbar.', logo: 'assets/img/distros/Bodhi Linux.png' },
