...
const DISTRO_FINDER_DATA = [
   { name: 'Ubuntu', codebase: 'ubuntu', countries: ['uk'], isoSizeMb: 4900, tags: ['einsteigerfreundlich', 'long-term-support', 'office'] },
   { name: 'Kubuntu', codebase: 'ubuntu', countries: ['uk'], isoSizeMb: 3800, tags: ['gutes-design', 'einsteigerfreundlich', 'office'] },
   ...
   { name: 'Linux Mint', codebase: 'ubuntu', countries: ['ie'], isoSizeMb: 2800, tags: ['einsteigerfreundlich', 'long-term-support', 'office'] },
   ...
   { name: 'Debian', codebase: 'debian', countries: ['us'], isoSizeMb: 3700, tags: ['long-term-support', 'server', 'verwaltung'] },
   ...
   { name: 'Arch Linux', codebase: 'arch', countries: ['de'], isoSizeMb: 1100, tags: ['rolling', 'fuer-experten', 'programmierer'] },
   { name: 'EndeavourOS', codebase: 'arch', countries: ['de'], isoSizeMb: 2300, tags: ['rolling', 'einsteigerfreundlich', 'programmierer'] },
   { name: 'Manjaro', codebase: 'arch', countries: ['de'], isoSizeMb: 3600, tags: ['rolling', 'gaming', 'einsteigerfreundlich'] },
   { name: 'Garuda Linux', codebase: 'arch', countries: ['de'], isoSizeMb: 4600, tags: ['gaming', 'gutes-design', 'rolling'] },
   { name: 'Fedora Workstation', codebase: 'redhat', countries: ['us'], isoSizeMb: 2100, tags: ['programmierer', 'gutes-design', 'bildung', 'ki'] },
