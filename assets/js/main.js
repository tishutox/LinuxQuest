...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'VectorLinux', codebase: 'slackware', countries: ['ca'], isoSizeMb: 700, tags: ['lightweight', 'systemd-free', 'fuer-experten'], description: 'Slackware-basierte, schlanke Distribution; Fokus auf Geschwindigkeit und Einfachheit.' },
   ...
   { name: 'AUSTRUMI', codebase: 'independent', countries: ['lv'], isoSizeMb: 700, tags: ['lightweight', 'datenrettung', 'einsteigerfreundlich'], description: 'Leichtgewichtige lettische Live-Distribution für ältere Hardware und Rettungseinsätze.' },
   { name: 'AryaLinux', codebase: 'independent', countries: ['in'], isoSizeMb: 2300, tags: ['programmierer', 'fuer-experten', 'source-based'], description: 'Quellbasierte Distribution mit eigenem Build-System für erfahrene Nutzer.' },
   ...
   { name: 'NimbleX', codebase: 'slackware', countries: ['ro'], isoSizeMb: 1200, tags: ['lightweight', 'datenrettung', 'systemd-free'], description: 'Slackware-basierte Live-Distribution, optimiert für schnelle Einsätze und Rettung.' },
