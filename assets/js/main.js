...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'openmamba', codebase: 'independent', countries: ['it'], isoSizeMb: 2500, tags: ['office', 'einsteigerfreundlich', 'gutes-design'], docsUrl: 'https://wiki.openmamba.org', downloadUrl: 'https://openmamba.org/en/download/', description: 'Italienische Rolling-Distribution mit hauseigenem Paket-Ökosystem.', logo: 'assets/img/distros/openmamba.png', videoUrl: 'https://youtu.be/f6wkO3dqzvk?si=SNZC3pW3CLgWReAh' },
