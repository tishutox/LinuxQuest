...
const DISTRO_FINDER_DATA = [
   ...
   { name: 'Kubuntu', codebase: 'ubuntu', countries: ['uk'], isoSizeMb: 4900, tags: ['gutes-design', 'einsteigerfreundlich', 'office'], docsUrl: 'https://help.ubuntu.com/community/Kubuntu', downloadUrl: 'https://kubuntu.org/getkubuntu/', description: 'Ubuntu mit KDE Plasma und Fokus auf ein aufgeräumtes Desktop-Erlebnis.', logo: 'assets/img/distros/Kubuntu.png' },
   ...
   { name: 'CachyOS', codebase: 'arch', countries: ['de'], isoSizeMb: 2400, tags: ['lightweight', 'gaming', 'gutes-design'], docsUrl: 'https://wiki.cachyos.org', downloadUrl: 'https://cachyos.org/download/', description: 'Arch-basiert mit Performance-Optimierungen, ZFS/Btrfs-Optionen und Gaming-Fokus.', logo: 'assets/img/distros/CachyOS.png', videoUrl: 'https://youtu.be/6x5bs-c_03Y?si=Qll-CiFiWR6a7X_f' },
   ...
   { name: 'NimbleX', codebase: 'slackware', countries: ['ro'], isoSizeMb: 1200, tags: ['lightweight', 'datenrettung', 'systemd-free'], docsUrl: 'https://nimblex.net/', downloadUrl: 'https://nimblex.net/', description: 'Slackware-basierte Live-Distribution, optimiert für schnelle Einsätze und Rettung.', logo: 'assets/img/distros/NimbleX.png' },
   ...
   { name: 'Bodhi Linux', codebase: 'ubuntu', countries: ['us'], isoSizeMb: 900, tags: ['lightweight', 'einsteigerfreundlich', 'bildung'], docsUrl: 'https://www.bodhilinux.com/w/wiki/', downloadUrl: 'https://www.bodhilinux.com/download/', description: 'Ubuntu-basiert mit Moksha-Desktop; sehr ressourcenschonend und anpassbar.', logo: 'assets/img/distros/Bodhi Linux.png', videoUrl: 'https://youtu.be/GhIzMUjbals?si=2dLTN_2ITInTeTbr' },
